...
def test_read_users(client: TestClient, db_session: Session):
    ...
    user1 = User(email="user1@example.com", hashed_password="pw1")
    user2 = User(email="user2@example.com", hashed_password="pw2")
...
def test_read_user(client: TestClient, db_session: Session):
    ...
    test_user = User(email="specific.user@example.com", hashed_password="pw123")
